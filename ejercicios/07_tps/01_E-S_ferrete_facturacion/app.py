...
class App(customtkinter.CTk):
    ...
    def btn_total_on_click(self):
        ...
        ProductoUno = int(ProductoUno)
        ProductoDos = int(ProductoDos)
        ProductoTres = int(ProductoTres)

        Total = ProductoUno + ProductoDos + ProductoTres

        text = (f"El resultado total es {Total}")
        alert (title= "El resultado es", message=text)
    ...
    def btn_promedio_on_click(self):
        ...
        text = (f"El promedio es {promedio}")
        alert (title= "El resultado es", message=text)
    ...
    def btn_total_iva_on_click(self):
        ...
        text = (f"El Total con IVA es {IVA}")
        alert (title= "El resultado es", message=text)
